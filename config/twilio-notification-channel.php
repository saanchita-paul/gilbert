...
return [
    ...
    'auth_token' => env('TWILIO_AUTH_TOKEN', 'acfdaed7f79b7edd6d36a29f0112ae52'), // optional when using username and password
    'account_sid' => env('TWILIO_ACCOUNT_SID', 'AC2388d7a8d6a0bee3ee53b0fa43fa8d67'),
