...
class ManualStatusChangeLogService
{
    ...
    public function saveLog()
    {
        ...
        if (count($data_keys) > 0) {
            ...
            Log::debug('Manual Status Change Log: No data to save!');
        }
    ...
    public function saveLogs($items = [])
    {
        if (count($items) > 0) {
            ...
            Log::debug('Manual Status Change Log - No items found to update!');
        }
    }
    ...
    private function saveApplicationStatus()
    {
        ...
        if ($connectionApplication) {
            ...
            Log::debug('Manual Status Change Log - No application found to update!');
        }
    }
    ...
    private function saveServiceStatus($service_type, $status_value)
    {
        ...
        if ($connectionApplication) {
            ...
            if ($service) {
                ...
                Log::debug('Manual Status Change Log - No connection service found to update!');
            }
        } else {
            Log::debug('Manual Status Change Log - No application found to update!');
        }
