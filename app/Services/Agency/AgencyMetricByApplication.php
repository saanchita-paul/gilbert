...
class AgencyMetricByApplication
{
    ...
    {
        return $builder->whereIn('source', $source);
    }
    ...
    {
        if($this->startDate && $this->endDate) {
            $builder->where($column, '>=' , $this->startDate)->where($column, '<=' , $this->endDate);
        }
        return $builder;
    }
    ...
    {
        if($this->agencyId) {
            $builder->where($column, $this->agencyId);
        }
        return $builder;
    }
    ...
    {
        if($this->officeId) {
            $builder->where($column, $this->officeId);
        }
        return $builder;
    }
    ...
    {
        if($this->accountManagerId) {
            $builder->whereHas('office', function (Builder $builder) use ($column) {
