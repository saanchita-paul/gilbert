...
{
    const MANDATORY_APP_FIELDS_NOT_HOOD_AI = ['title', 'first_name', 'last_name', 'phone', 'email', 'dob', 'address_unit', 'street_address', 'street_number', 'street_name', 'city', 'postcode', 'state', 'country', 'nmi'];
