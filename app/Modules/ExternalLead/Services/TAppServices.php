...
class TAppServices
{
    ...
    public function storeToTApp()
    {
        $this->tApp->agent_name = $this->getAgentName() ?? null;
        $this->tApp->agency_name = $this->userRequestData->agency_name ?? null;
        $this->tApp->agent_email = $this->userRequestData->agent_email ?? null;
        $this->tApp->save();
        return $this->tApp;
    }
