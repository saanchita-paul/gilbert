...
class CreateAuthorizedPersonService
{
    public function save(ConnectionApplication $app, array $data)
    {
        ...
        $authorisedPerson->title = !empty($data['tenancy_secondary_title']) ?
        ...
        $authorisedPerson->role = !empty($data['tenancy_secondary_permission_type']) ?
        ...
        $authorisedPerson->identification_type = !empty($data['secondary_tenancy_identification_type']) ?
        ...
        $authorisedPerson->state = !empty($data['secondary_tenancy_identification_state']) ?
            $addressService->mapState($data['secondary_tenancy_identification_state']) : null;
        $authorisedPerson->country = !empty($data['secondary_tenancy_identification_country']) ?
            $addressService->mapCountry($data['secondary_tenancy_identification_country']) : null;
        $authorisedPerson->card_color = !empty($data['secondary_tenancy_medicare_card_color']) ?
