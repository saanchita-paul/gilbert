                        ...
                        <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                            <tr>
                                <td style="padding:0 0 20px 0;color:#252830;">
                                    ...
                                    <p style="margin:0 0 12px 0;font-size:14px;line-height:18px;font-family:'Ubuntu';font-weight:400;">Welcome to the HOOD community and congratulations on joining the moving revolution.</p>
                                    <p style="margin:0 0 12px 0;font-size:14px;line-height:18px;font-family:'Ubuntu';font-weight:400;">HOOD is the place to go when you’re starting a new adventure, an all-in-one moving platform, doing good along the way.</p>
                                    <p style="margin:0 0 12px 0;font-size:14px;line-height:18px;font-family:'Ubuntu';font-weight:400;">It’s time to setup your account so you can start submitting the details of your movers, ensuring their lights are on the day they move it.</p>
                                    <p style="margin:0 0 12px 0;font-size:14px;line-height:18px;font-family:'Ubuntu';font-weight:400;">Click the link below to create your password and activate your account, it’ll only take 30 seconds.</p>
                                </td>
                            </tr>
                                ...
                                <td style="padding:0 0 20px 0">
                                    <!--[if mso]>
                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ url('/confirm-invitation?token=' .$token) }}" style="height:36px;v-text-anchor:middle;width:150px;" arcsize="5%" strokecolor="#542E89" fillcolor="#542E89">
                                                <w:anchorlock/>
                                                <center style="color:#ffffff;font-family:'Ubuntu';font-size:14px;">Activate Account</center>
                                            </v:roundrect>
                                        <![endif]-->
                            ...
                            <tr>
                                <td style="padding:0 0 20px 0;color:#252830;">
                                    <p style="margin:0 0 12px 0;font-size:14px;line-height:18px;font-family:'Ubuntu';font-weight:400;">Having issues? Contact your account manager for customer support.</p>
                                    <p style="margin:0 0 12px 0;font-size:14px;line-height:18px;font-family:'Ubuntu';font-weight:400;">Looking forward to your first application and seeing you at our next event.</p>
                                </td>
                            </tr>
