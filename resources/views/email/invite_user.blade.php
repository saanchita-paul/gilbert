...
<div class="main-container" style="font-family: 'Ubuntu'; font-style: normal; font-weight: 400; font-size: 14px; line-height: 18px; color: #252830; max-width: 800px; margin: 0 auto;">
    ...
    <section style="padding: 10px;">
        ...
        <div style="margin-top: 40px; margin-bottom: 40px;">
            <p>
                <a href="{{ url('/confirm-invitation?token=' .$token) }}" target="_blank" style="padding: 15px 25px; box-shadow: 0 0 10px 10px #673ab71a; background: #542E89; color: white; border-radius: 10px; text-decoration: none; font-weight: 700;">Activate Account</a>
            </p>
        </div>
