                ...
                <tr>
                    <td>
                        <img src="{{ asset('/assets/images/email/user_invite.png') }}" alt="Banner Image" width="100%"
                             style="height:auto;display:block;border-top-left-radius:10px; border-top-right-radius:10px;"/>
                    </td>
                </tr>
                <tr>
                                        ...
                                        <tr>
                                            <td style="padding:0 0 0 0;">
                                                <a href="https://hoodagents.com.au/">
                                                    <img src="{{ asset('/assets/images/email/rea.png') }}" alt="REA"
                                                         width="auto" style="display:block;border:0;"/>
                                                </a>
                                            </td>
                                            <td style="padding:0 0 0 10px;">
                                                <a href="https://www.facebook.com/hood.ai.official">
                                                    <img src="{{ asset('/assets/images/email/fb.png') }}" alt="Facebook"
                                                         width="auto" style="display:block;border:0;"/>
                                                </a>
                                            </td>
                                            <td style="padding:0 0 0 10px;">
                                                <a href="https://www.instagram.com/hood.ai_official/">
                                                    <img src="{{ asset('/assets/images/email/instagram.png') }}"
                                                         alt="Instagram" width="auto" style="display:block;border:0;"/>
                                                </a>
                                            </td>
                                            <td style="padding:0 0 0 10px;">
                                                <a href="https://www.linkedin.com/company/hood-ai/mycompany/">
                                                    <img src="{{ asset('/assets/images/email/linkedin.png') }}"
                                                         alt="Linkedin" width="auto" style="display:block;border:0;"/>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
