...
<body>
    ...
    <div style="border: 5px solid gray; margin-top: 20px; font-weight: bold; ">
            ...
            <div style="color: black; padding: 0px 0px; font-size: 20px; font-weight: normal; width: 100%; border: 1px solid gray;">
                ...
                <div style="width: 8%; height: 300px; padding-left: 0px; float: left; border: 1px solid gray;">
                    <div style="color: #620088; font-weight: bold; -webkit-transform: rotate(90deg); text-align: left; white-space: nowrap; margin-top: 100px; margin-left: -50px;">
