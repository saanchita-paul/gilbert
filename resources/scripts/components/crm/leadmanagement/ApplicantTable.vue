    ...
    data() {
        return {
            ...
            srcOptions: [
                ...
                {text: 'Our Property ', value: 'our_property', icon: '/assets/images/icons/company/our-property.png'},
                {text: 'Property Me ', value: 'property_me', icon: '/assets/images/icons/company/propertyMe.png'},
            ],
            headers:  [
                {
                    text: 'Name',
