<template>
    <v-card class="elevation-2 timeline-card" color="gray" :class="{active:false}">
        ...
        <p class="title">Agency: <span class="note-date">{{ note.leads.agency || 'N/A' }}</span></p>
        ...
        <p class="title mt-3">Initial Payment Amount: <span class="note-data">${{ note.leads.initial_payment_amount || 'N/A' }}</span></p>
