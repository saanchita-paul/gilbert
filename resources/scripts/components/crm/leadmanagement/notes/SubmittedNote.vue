<template>
    <v-card class="elevation-2 timeline-card" color="gray" :class="{active:false}">
        ...
        <p class="title mt-3"> Go Neutral: <span class="note-data">{{ typeof note.leads.ea_go_neutral === 'string' ? note.leads.ea_go_neutral : (note.leads.ea_go_neutral === 1 ? "Yes" : "No") }}</span></p>
