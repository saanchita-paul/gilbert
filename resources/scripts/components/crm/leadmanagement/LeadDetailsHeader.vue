        ...
        <v-col cols="12" class="d-flex justify-space-between">
            ...
            <div>
                <div class="d-flex justify-end">
                    ...
                    <v-btn v-if="isChatBotApplication" outlined @click="sendToChatBotConfirmModal" class="ml-1">Assign to Chatbot<v-icon class="pl-3">mdi-facebook-messenger</v-icon></v-btn>
                </div>
...
name: "LeadDetailsHeader",
    ...
    computed:{
        ...
        isChatBotApplication() {
            return this.leadSummary?.is_sent_to_chatbot;
        }
    },
    methods: {
        goToBack()
