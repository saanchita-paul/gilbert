    ...
    <v-row class="personal-details-row">
        ...
        <v-col cols="4">
            ...
            <div class="crm-text-field">
                ...
                <div class="text-field">
                    <ValidationProvider name="Shipping Address" v-slot="{ errors }">
                        <v-textarea :value="shippingAddressMsg"
...
export default {
    ...
    data() {
        return {
            ...
            emailMarketing: ApplicationSummaryConstantService.getBooleanDD(),
            emailBillingDD: ApplicationSummaryConstantService.getBooleanDD(),
            statesDD: ApplicationSummaryConstantService.getStatesDD(),
            tenantTypeDD: ApplicationSummaryConstantService.getTenantTypeDD(),
            homeRenovationDD: ApplicationSummaryConstantService.getBooleanDD(),
            electricityDD: ApplicationSummaryConstantService.getBooleanDD(),
            phoneTypeDD: ApplicationSummaryConstantService.getPhoneTypeDD(),
            familyViolanceTypeDD: ApplicationSummaryConstantService.getFamilyViolenceTypeDD(),

            propertyTypeDD: ApplicationSummaryConstantService.getPropertyTypeDD(),
            accessRequirement: ApplicationSummaryConstantService.getBooleanDD(),
            inspectionTimeNSW: ApplicationSummaryConstantService.getInspectionTimeNSWDD(),
            additional_access_information: ApplicationSummaryConstantService.getAdditionalAccessInfoDD(),
            additional_access_information_nsw: ApplicationSummaryConstantService.getAdditionalAccessInfoNSWDD(),
            additional_access_information_sa: ApplicationSummaryConstantService.getAdditionalAccessInfoSADD(),
            additional_access_information_act: ApplicationSummaryConstantService.getAdditionalAccessInfoACTDD(),
    ...
    methods: {
        ...
        openShippingAddress() {
            this.shippingAddressFlag = true;
        },

        closeShippingAddress() {
            this.shippingAddressFlag = false;
        },
